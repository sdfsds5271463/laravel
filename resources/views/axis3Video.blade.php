...
@section('main')
	...
	影片播放器設計上，僅是透過Javascript取得並修改video元素的屬性達成功能，不過成效相當好，透過精準的影片對應動作讓我能夠定義人體步態的三軸特徵。</p>

    <video id="Video1" class="img-responsive" width="100%" loop>您的瀏覽器不支援Html5影片播放器。</video>
