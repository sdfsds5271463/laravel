...
@section('main')
    ...
    <h1>XML天氣概況</h1>
    	<p>此頁面為使用yql代理伺服器跨域，存取<a href="http://opendata.cwb.gov.tw/" target="_blank">中央氣象局資料開放平台</a>之一周天氣XML，透過Javascript將天氣資訊崁入GoogmeMap，並設計與地圖的額外互動行為，點擊地圖中的天氣符號可以查看一周天氣。</p>
